...
function M(e) {
	...
	for (let i = 0; i < t.length; i++) {
		const r = t[i].claim_order,
			o = (s > 0 && t[n[s]].claim_order <= r ? s + 1 : H(1, s, (_) => t[n[_]].claim_order, r)) - 1;
		a[i] = n[o] + 1;
		const u = o + 1;
...
function S(e, t, n, a, s = !1) {
	...
	const c = (() => {
		for (let l = e.claim_info.last_index; l < e.length; l++) {
			...
			if (t(f)) {
				const i = n(f);
				return i === void 0 ? e.splice(l, 1) : (e[l] = i), s || (e.claim_info.last_index = l), f;
			}
		}
...
class de {
	...
	$set(t) {
		this.$$set && !E(t) && ((this.$$.skip_bound = !0), this.$$set(t), (this.$$.skip_bound = !1));
	}
}
const K = '4';
